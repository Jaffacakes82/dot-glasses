...
namespace DotGlasses.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903215422_CoatingSetsWithPairingAndExclusion")]
    partial class CoatingSetsWithPairingAndExclusion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotGlasses.Domain.Entities.CoatingExclusion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CoatingRefIdA")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CoatingRefIdB")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CoatingRefIdA");

                    b.HasIndex("CoatingRefIdB");

                    b.HasIndex("CoatingRefIdA", "CoatingRefIdB")
                        .IsUnique();
            ...
            modelBuilder.Entity("DotGlasses.Domain.Entities.SaleCoating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SaleId", "CoatingRefId")
                        .IsUnique();

                    b.ToTable("SaleCoatings", (string)null);
                });
